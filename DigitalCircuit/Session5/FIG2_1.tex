...
% JKFF CHIP 1 (-4.0)
    ...
    \draw[hwSolution,thick,o-] (-4.8,1.2) node[right]{$~~~C_{1}$} -- (-5.5,1.2);
...
% JKFF CHIP 2 (+0.0)
    ...
    \draw[hwSolution,thick,o-] (-0.8,1.2) node[right]{$~~~C_{1}$} -- (-1.5,1.2);
...
% JKFF CHIP 3 (+4.0)
    ...
    \draw[hwSolution,thick,o-] ( 3.2,1.2) node[right]{$~~~C_{1}$} -- ( 2.5,1.2);
